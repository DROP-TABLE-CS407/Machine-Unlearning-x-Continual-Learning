...
![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/cifar100CLcomp.png?raw=true "Our own continual learning results for the continuum of 20 tasks from CIFAR 100 running on AGEM and GEM variants")
...
![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/miaAGEM.png?raw=true "MIA results proving that a continual learner can maintain model utility whilst reducing risk of MIA AUC for samples of the the entire train set. Only the buffer samples (~10% of the original train data) become memorised protecting the rest of the train data")

### A4 Test Set Task Accuracies Using NegGEM:

![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/a4neggem.png?raw=true "NegGEM on task sequence A4, all test accuracies shown")

### A4 CL-TOW values across all algorithms:

![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/tow_scores_a4.png?raw=true "A4 CL-TOW values across all algorithms")

### A4 $CLU_{mix}$ values across all algorithms:

![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/CLUA4.png?raw=true "A4 CLUmix values across all algorithms")

### B4 $CLU_{mix}$ values across all algorithms:

![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/CLUB4.png?raw=true "B4 CLUmix values across all algorithms")

### C4 $CLU_{mix}$ values across all algorithms:

![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/CLUC4.png?raw=true "C4 CLUmix values across all algorithms")

### C4v2 $CLU_{mix}$ values across all algorithms:

![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/CLUB4.png?raw=true "C4v2 CLUmix values across all algorithms")

### D4 $CLU_{mix}$ values across all algorithms:

![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/CLUD4.png?raw=true "D4 CLUmix values across all algorithms")

### E4 $CLU_{mix}$ values across all algorithms:

![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/CLUE4.png?raw=true "E4 CLUmix values across all algorithms")

### F4 $CLU_{mix}$ values across all algorithms:

![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/CLUF4.png?raw=true "F4 CLUmix values across all algorithms")

### G4 $CLU_{mix}$ values across all algorithms:

![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/CLUG4.png?raw=true "G4 CLUmix values across all algorithms")

### H4 $CLU_{mix}$ values across all algorithms:

![Alt text](https://github.com/DROP-TABLE-CS407/Machine-Unlearning-x-Continual-Learning/blob/main/plot/CLUH4.png?raw=true "H4 CLUmix values across all algorithms")
